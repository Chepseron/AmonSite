            ...
            <div class="main_menu">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="container box_1620">
                        ...
                        <a class="navbar-brand logo_h" href="index.html"><img src="img/personal.jpg" width="50px" height="50px" style="border-radius: 50%;"></a>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="personal_text">
                                    ...
                                    <p>I possess over nine years of experience developing software for multiple clients in various
                                        environments. I possess solid knowledge of Java, C# C++, C, Android,NodeJS, AngularJS, Mysql,
                                        MSSql, javascript and software engineering skills, I also possess leadership skills as highlighted
                                        in the various projects undertaken, While in project Management, i have been successful in
                                        providing high level technical direction to drive projects from conception and design through GA
                                        and deployment.</p>
                                    <ul class="list basic_info">
                                        <li><a href="#"><i class="lnr lnr-calendar-full"></i> 20th April, 1985</a></li>
                                        <li><a href="#"><i class="lnr lnr-phone-handset"></i> +254728140544, +254770123835</a></li>
                                        <li><a href="#"><i class="lnr lnr-envelope"></i> chepseron@gmail.com</a></li>
                ...
                <div class="row welcome_inner">
                    <div class="col-lg-6">
                        <div class="welcome_text">
                            <h4>Who is Sabul?</h4>
                            <p>A few words that describe me: Technology enthusiast, introvert, resilient,a curious individual and above all a programmer. </p>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="wel_item">
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <ul class="list">
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Sep 2017 to present</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Software Developer <br />Craft Silicon, Kenya</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Jan 2017 — Sept 2017</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Software Developer <br />Guarantee Trust Bank, Kenya</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Jan 2016 — June 2017</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Assistant Lecturer/Course Instructor<br />University Of Eldoret, Eldoret, Kenya</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>Software Developer<br />Icon Trace and Transactions Limited., Nairobi</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Jan 2016 — June 2016</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Software Developer<br />Obbitel Kenya, Nairobi</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Jan 2013 — Dec 2015</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Software Developer/IT Support/Course Instructor<br />Moi University, Eldoret, Kenya</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Dec 2010 — Jan 2013</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Software Developer<br />Jambopay Limited, Kenya</p>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <ul class="list">
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Apr 2013 — Dec 2015</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Master of Science In Distributed Computing Technology <br />University Of Nairobi, Kenya</p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="media">
                                        <div class="d-flex">
                                            <p>Aug 2006 — Dec 2010</p>
                                        </div>
                                        <div class="media-body">

                                            <p>Computer Science and Technology <br />Maseno University, Kisumu. Kenya</p>
                                        </div>
                                    </div>
                                </li>
